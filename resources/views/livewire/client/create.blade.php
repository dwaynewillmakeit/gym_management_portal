<div class="row">
            ...
            <div class="card-body">
              ...
              <form id="" class="mb-3" wire:submit.prevent="save">
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="name" name="name" wire:model="client.name"
                             placeholder="Name">
                  ...
                  <div class="col">
                    ...
                    @if($client->is_on_diet_plan)
                      <div class="mb-4">
                        ...
                        <textarea class="form-control " id="diet-plan-description"
                                  wire:model="client.diet_plan_description"></textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="muscle" placeholder="Muscle"
                             wire:model="client.muscle"/>
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control " id="ta-person-training"
                            wire:model="client.personal_training"></textarea>
                ...
                @if($errors->any())
                  <p class="text-danger text-center font-bold mt-3">Failed to save Client Information. Please address
                    all errors and resubmit</p>
  ...
  @else
    <h4 class="text-center text-secondary">You done have permission to Add Clients </h4>
